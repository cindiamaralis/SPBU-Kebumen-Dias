...
var format_SPBUKEBUMEN_3 = new ol.format.GeoJSON();
var features_SPBUKEBUMEN_3 = format_SPBUKEBUMEN_3.readFeatures(json_SPBUKEBUMEN_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SPBUKEBUMEN_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SPBUKEBUMEN_3.addFeatures(features_SPBUKEBUMEN_3);
var lyr_SPBUKEBUMEN_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SPBUKEBUMEN_3, 
                style: style_SPBUKEBUMEN_3,
                popuplayertitle: 'SPBU KEBUMEN',
                interactive: true,
                title: '<img src="styles/legend/SPBUKEBUMEN_3.png" /> SPBU KEBUMEN'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_ADMINISTRASIDESA_1.setVisible(true);lyr_JALAN_2.setVisible(true);lyr_SPBUKEBUMEN_3.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_ADMINISTRASIDESA_1,lyr_JALAN_2,lyr_SPBUKEBUMEN_3];
...
lyr_SPBUKEBUMEN_3.set('fieldAliases', {'NO': 'NO', 'NAMA TEMPA': 'NAMA TEMPA', 'x': 'x', 'y': 'y', 'foto': 'foto', });
...
lyr_SPBUKEBUMEN_3.set('fieldImages', {'NO': 'TextEdit', 'NAMA TEMPA': 'TextEdit', 'x': 'TextEdit', 'y': 'TextEdit', 'foto': 'ExternalResource', });
...
lyr_SPBUKEBUMEN_3.set('fieldLabels', {'NO': 'inline label - always visible', 'NAMA TEMPA': 'inline label - always visible', 'x': 'inline label - always visible', 'y': 'inline label - always visible', 'foto': 'inline label - always visible', });
lyr_SPBUKEBUMEN_3.on('precompose', function(evt) {
